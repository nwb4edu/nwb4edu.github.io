...
# 
# In addition to spike times, researchers are often interested in studying the **local field potential** (LFP), or the collective sum of all of the neurons in a given area. We can filter this LFP for particular frequencies, and even use it to distinguish between layers of cortex. 
# 
# <hr>
# 
...
# * For a useful overview of electrophysiology, see the [Guide to Research Techniques](https://www.sciencedirect.com/science/article/pii/B9780128005118000046).
